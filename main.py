...
def home_page():
        ...
        def user_page():
            ...
            def book_ticket():
                ...
                def show_flights():
                    ...
                    def book_flight():
                        ...
                        if selected_flight:
                            ...
                            gender_entry = ttk.Combobox(booking_page, values=["Male", "Female"])
                ...
                back_button =Button(book_window, text="Back", bg="#4682B4", fg="white", font=('Helvetica',10,'bold'),width=10, height=1,command=lambda:[book_window.destroy(), root.deiconify()])
            ...
            back_button = Button(root, text="Back",bg="#4682B4", fg="white", font=helv36,width=20, height=3, command=lambda:[root.destroy(),home_page()])
